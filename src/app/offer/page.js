...
export const metadata = PAGE_METADATA.offer;
    ...
    <div className="flex min-h-dvh flex-col bg-wd-bg text-wd-text">
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-wd-text-secondary">
          ...
          <section id="recurring" className="space-y-3">
            <h2 className="text-lg font-bold text-white">4. Рекуррентные (автоматические) платежи</h2>
            <ol className="list-decimal space-y-2 pl-5">
              <li>
                При оформлении подписки на тариф «Диалог», «История» или «Вселенная» пользователь
                даёт согласие на автоматическое списание средств в размере стоимости подписки за
                следующий период (1 месяц или 1 год) с привязанной банковской карты.
              </li>
              <li>Списание происходит за 1 день до окончания текущего периода подписки.</li>
              <li>
                Пользователь может отменить подписку в любой момент в личном кабинете. Отмена
                подписки не даёт права на возврат средств за уже оплаченный период.
              </li>
              <li>
                В случае изменения стоимости подписки пользователь будет уведомлен за 14 дней до
                следующего списания.
              </li>
              <li>
                Возврат средств за неиспользованный период подписки не производится, за исключением
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white">5. Порядок отказа от услуг и возврата средств</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white">6. Контактная информация и реквизиты</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-white">7. Политика обработки персональных данных</h2>
            <p>
